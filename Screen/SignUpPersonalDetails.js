...
this.checkAllValidations(text)
  ...
  onFocusDate(text) {
    this.setState({
      dateTextBoxBackgroundColor: '#4F4F4F',
      dateTextBoxBorderColor: 'white',
      dateTextBoxPlaceholderColor: 'white',
  ...
  onBlurDate(text) {
    this.setState({
      dateTextBoxBackgroundColor: 'transparent',
      dateTextBoxBorderColor: '#4F4F4F',
      dateTextBoxPlaceholderColor: '#4F4F4F',
    })
  ...
  onFocusMonth() {
    this.setState({
      monthTextBoxBackgroundColor: '#4F4F4F',
      monthTextBoxBorderColor: 'white',
      monthTextBoxPlaceholderColor: 'white', 
    })
  ...
  onBlurMonth(text) {
    this.setState({
      monthTextBoxBackgroundColor: 'transparent',
      monthTextBoxBorderColor: '#4F4F4F',
      monthTextBoxPlaceholderColor: '#4F4F4F',
    })
  ...
  onFocusYear() {
    this.setState({
      yearTextBoxBackgroundColor: '#4F4F4F',
      yearTextBoxBorderColor: 'white',
      yearTextBoxPlaceholderColor: 'white',
  ...
  onBlurYear(text) {
    this.setState({
      yearTextBoxBackgroundColor: 'transparent',
      yearTextBoxBorderColor: '#4F4F4F',
      yearTextBoxPlaceholderColor: '#4F4F4F',
    })

    if (parseInt(text, 10) < 2000)
    {
